...
class Player(object):
    ...
    def go_to(self, location):
        ...
        if destination_place.locked:
            print(location, 'is locked! Go look for a key to unlock it')
        else:
    ...
    def unlock(self, place):
        ...
        #    new_exit = [exit for exit in exits if exit == place][0]
        #    if exits[new_exit][0].locked:
        #        key.use(place)
        #        exits[new_exit][0].locked = not exits[new_exit][0].locked
        #    else:
        #        print(place + ' is already unlocked!')
        #else:
        #    print(place + ' can\'t be unlocked without a key!')        
