...
class Fib():
    ...
    def next(self):
        ...
        if self.value == 0:
            ...
            Fib.previous, self.value = self.value, Fib.previous + self.value
...
class VendingMachine:
    ...
    def restock(self, quantity):
        self.good += quantity
        return 'Current {0} stock: {1}'.format(self.product, self.good)
    ...
    def vend(self):
        if self.good > 0:
            ...
            if difference > 0:
                ...
                return 'You must deposit ${0} more.'.format(-1 * difference)
        else:
